...
const makeApiController = (db: any) => {
  ...
  Router.getAsync('/messages', async (req: any, res: any) => {
    ...
    messages.forEach((message: any) => {
      ...
      if (username) {
        message.votes.forEach((vote: any) => {
  ...
  Router.getAsync('/avatar/:username', async (req: any, res: any) => {
